...
import "./ZakpayExperience.css"

const ZakpayExperience = () => {
  return (
    <div className="z-experience photo-section">
    <div className="max-width">
      <div className="photo-section-child">
        <div className="photo-section-top">
          <div className="photo-section-heading z-experience-heading">
        ...
        <div className="photo-section-bottom">
          <div className="photo-section-description z-experience-description">
...
export default ZakpayExperience